...
\begin{document}	
	...
	\section{Useful Mathematics Concepts, Rules, and Identities}
		...
		\begin{enumerate}
			...
			Thus, from the factors we can extrapolate possible rational zeroes. Possible zeroes are : , $\pm\frac{1}{2}$, $\pm\frac{1}{4}$, $\pm\frac{1}{8}$, $\pm3$, $\pm\frac{3}{2}$, $\pm\frac{3}{4}$, and $\pm\frac{3}{8}$.
		...
		Integration is a fundamental concept of calculus that allows one to find the area under a given curve.
